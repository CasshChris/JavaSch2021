...
public class creditCardValidation {
    ...
    static int[] prefixes = new int[] { visa_prefix, masterCard_prefix, americanExpress_prefix, discover_prefix };
    ...
    public static void main(String[] args) {
        ...
        long creditCardNum = scan.nextLong(); // valid = 4388576018410707, invalid = 43885760184026243885760184026266
